...
export const demoCategories: Category[] = [
  {
    ...
    description: "Beautiful Islamic calligraphy and artistic wall decorations",
    productCount: 24,
  },
  {
    _id: "2",
    ...
    description: "Essential items for daily prayers and worship",
    productCount: 18,
  },
  {
    _id: "3",
    ...
    description: "Elegant Islamic-themed home decorations",
    productCount: 32,
  },
  {
    _id: "4",
    name: "Calligraphy",
    slug: { current: "calligraphy" },
    image: {
      asset: { url: "/images/dummy1.jpeg" },
      alt: "Islamic Calligraphy",
    },
    description: "Handcrafted Arabic calligraphy artwork",
    productCount: 15,
  },
  {
    _id: "5",
    name: "Books & Quran",
    slug: { current: "books-quran" },
    image: {
      asset: { url: "/images/demo-product.jpeg" },
      alt: "Islamic Books and Quran",
    },
    description: "Religious books, Quran, and Islamic literature",
    productCount: 28,
  },
  {
    _id: "6",
    ...
    description: "Beautiful Islamic-inspired jewelry pieces",
    productCount: 12,
  },
];
