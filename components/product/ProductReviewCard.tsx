...
export function ProductReviewCard({ reviews, className }: ReviewsStripProps) {
          ...
          <motion.article key={rev._id} variants={item} className={cn()}>
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              ...
              {rev.productVideo?.asset?.url ? (
                <span className="inline-flex items-center px-2 py-1 text-xs border rounded-lg text-zinc-600 dark:text-zinc-300">
                  🎥 Video attached
                </span>
              ) : null}
            </div>
